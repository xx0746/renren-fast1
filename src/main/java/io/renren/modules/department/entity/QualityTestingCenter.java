...
@ApiModel(value="QualityTestingCenter对象", description="质检中心")
public class QualityTestingCenter implements Serializable {
    ...
    @ExcelProperty(value = "先进性与创新性 5%",index = 4)
    private String advancedInnovation;

    @ApiModelProperty(value = "调查研究")
    @ExcelProperty(value = "调查研究 5%",index = 5)
